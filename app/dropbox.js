...
const accessToken = process.env.BRIDGE_BOT_DROPBOX_ACCESS_TOKEN;

class Dropbox {

  static writeFile(fileNameToWrite, fileContentToWrite, async) {
    let result;
  ...
  static readFile(fileNameToRead, async) {
      const xhr = new XMLHttpRequest();
      let result;
